class Game extends Phaser.State{
    ...
    private guiText0: Phaser.BitmapText;
    private guiText1: Phaser.BitmapText;
    private guiText2: Phaser.BitmapText;
    private scrollSpeed: number;
    private cloudPool: Phaser.Group;
    private nextCloudAt: number;
    private cloudDelay: number;
    private bonusPool: Phaser.Group;
    private cursors: Phaser.CursorKeys;
    private bulletPoolsMob: any[];
    private mobPools: any[];
    private mobPoolsGround: any;
    private groundHeight: number;
    private enemyDelay: any[];
    private nextEnemyAt: any[];
    private enemyDelayGround: any[];
    private nextEnemyGroundAt: any[];
    ...
    public playerVSbullet(player, bullet) {
    ...
    public playerVSbonus(player, bonus) {
        bonus.kill();
