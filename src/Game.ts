function remove(array: any[], from, to?) {
...
class Game extends Phaser.State {
    ...
    public guiText0: Phaser.BitmapText;
    public guiText1: Phaser.BitmapText;
    public guiText2: Phaser.BitmapText;
    public scrollSpeed: number;
    public cloudPool: Phaser.Group;
    public nextCloudAt: number;
    public cloudDelay: number;
    public bonusPool: Phaser.Group;
    ...
    public enemyDelayGround: any[];
    public nextEnemyGroundAt: any[];
    public terrainData: any[];
    public scrollMax: number;
    public scrollCounter: number;
    public groundWidth: number;
    public map: Phaser.Tilemap;
    public ground: Phaser.TilemapLayer;
